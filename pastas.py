triggers = ["goat", "innit", "based", "simp", "piss", "furry", "kephrii", "cringe", "flashy", "ninja", "what are you doing", "cock", "cum", "peak", "hampter", 'mercy', "scort", "ratio", "shadowplay"]
triggerResponse = [
...
#pee, piss
"Pee is currently dripping down my leg, it is warm. :)",

#furry
"I'm not a furry, I swear! I just really, really like anthropomorphic animals and the artistic potential you can get out of them. I mean, sure I drew what is essentially an anthropomorphic bunny as a new OC as of recent, but doesn't mean I'm a furry! Sure, I love looking at other people's art and it may steadily be becoming a part of my visual aesthetic, but I'll tell you yet again: I AM NOT A FURRY. I never will be, I would feel great shame if I were a furry.",

#kephrii
"I made $20,000 last month. I don't care for your reactions. Don't value your attention so highly. I truly don't care. This is my amusement merely while I eat.",
...
#flashy
"Idk which ow T2 editor needs to hear this but flashy fast cuts ≠ good editing. All of u sad Abt not being picked for may melee I've seen your cuts and there's a reason the ones picked, were picked over yours. Egoing won't make you better at your craft.",

#ninja
"I’m in the middle of carrying a League Of Legends game about to close out, and my braless wife brings me a sandwich (not asked for) with chips as I get a double kill bot lane. So how is your day going?",

#what are you doing
"YO MAMA",

#cock
'and balls (never forget the balls.)',

#cum
'cum',

#peak
"./data/KW2fX8VRPVwcPYUC.mp4",
